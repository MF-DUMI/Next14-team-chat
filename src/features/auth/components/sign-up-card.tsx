            ...
            <CardContent className="space-y-5 px-0 pb-0">
                ...
                <Input
                    ...
                    <Input
                        ...
                        required
                    />
                    <Button typeof="submit" className="w-full" size="lg" disabled={pending}>
                        Continue
                    </Button>
                </form>
                <Separator />
                ...
                <p className="text-xs text-muted-foreground">
                    Already have an account? <span onClick={() => setState("signIn")} className="tex-sky-700 hover:underline cursor-pointer">Sign in</span>
                </p>
            </CardContent>
        </Card>
    )
