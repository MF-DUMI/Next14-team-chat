    ...
    return (
        <div className="flex flex-col mt-3 px-2">
            <div className="flex items-center px-3.5 group">
                <Button onClick={toggle} className="p-0.5 text-sm text-[#f9edffcc] shrink-0 size-6" variant="transparent">
                    <FaCaretRight className={cn("size-4 transition-transform ",on && "rotate-90")}/>
                </Button>
                <Button variant="transparent" size="sm" className="group px-1.5 text-[#f9edffcc] h-[28px] justify-start overflow-hidden items-center">
